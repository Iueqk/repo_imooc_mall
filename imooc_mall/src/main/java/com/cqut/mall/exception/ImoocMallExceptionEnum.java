package com.cqut.mall.exception;

public enum ImoocMallExceptionEnum {
    NEED_USER_NAME(10001, "用户名不能为空"),
    NEED_PASSWORD(10002, "密码不能为空"),
    PASSWORD_TOO_SHORT(10003, "密码至少为8位"),
    NAME_EXISTED(10004,"名字不能重复"),
    INSERT_FAILED(10005,"插入失败!服务器正忙,请重试"),
    WRONG_PASSWORD(10006,"登录失败!密码错误"),
    NEED_LOGIN(10007,"用户未登录"),
    UPDATE_FAILED(10008,"更新失败"),
    NEED_ADMIN(10009,"无管理员权限"),
    PARAM_NOT_NULL(100010,"参数不能为空"),
    CREATE_FAILED(100011,"新增失败!服务器正忙,请重试"),
    REQUEST_PARAM_ERROR(100012,"请求参数错误"),
